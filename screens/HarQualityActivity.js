...
export default class HarQualityActivity extends React.Component {
  constructor(props) {
    super(props);
  ...
  changeActiveRadioArchingButton1(index) {
    ...
    this.setState({radioArchingItems1: this.state.radioArchingItems1}, () => {
      this.setState({
        archingOption1: this.state.radioArchingItems1[index].label,
      });
    });
  }
  ...
  changeActiveRadioArchingButton2(index) {
    ...
    this.setState({radioArchingItems2: this.state.radioArchingItems2}, () => {
      this.setState({
        archingOption2: this.state.radioArchingItems2[index].label,
      });
    });
  }
  ...
  changeActiveRadioArchingButton3(index) {
    ...
    this.setState({radioArchingItems3: this.state.radioArchingItems3}, () => {
      this.setState({
        archingOption3: this.state.radioArchingItems3[index].label,
      });
    });
  }
  ...
  changeActiveRadioArchingButton4(index) {
    ...
    this.setState({radioArchingItems4: this.state.radioArchingItems4}, () => {
      this.setState({
        archingOption4: this.state.radioArchingItems4[index].label,
      });
    });
  }
      ...
      if (houseNumber) {
        if (rowNumber) {
          ...
          if (this.state.isItConnected === 'Online') {
            ...
            }&dropping_data4=${that.state.droppingOption4}&arching_data1=${
              that.state.archingOption1
            }&arching_data2=${that.state.archingOption2}&arching_data3=${
              that.state.archingOption3
            }&arching_data4=${that.state.archingOption4}&trusscutting_data1=${
        ...
        <ImageBackground
          ...
          <ScrollView
            ...
            <View style={styles.direction}>
              ...
              <Text style={styles.textClear} onPress={this.clearArchingRadio}>
                Clear
              </Text>
            </View>
            ...
            <View style={styles.flexDirection}>
              {this.state.radioArchingItems1.map((item, key) => (
                <RadioButton
                  key={key}
                  button={item}
                  onClick={this.changeActiveRadioArchingButton1.bind(this, key)}
                />
              ))}
            </View>
            ...
            <Text style={styles.titleHeading2Text}>
              2) Arching at the right stage. Arch: as long as it fits and
            ...
            <View style={styles.flexDirection}>
              {this.state.radioArchingItems2.map((item, key) => (
                <RadioButton
                  key={key}
                  button={item}
                  onClick={this.changeActiveRadioArchingButton2.bind(this, key)}
                />
              ))}
            </View>
            ...
            <Text style={styles.titleHeading2Text}>
              3) De-skinning of truss. Not forcing truss on to tear skin{' '}
            ...
            <View style={styles.flexDirection}>
              {this.state.radioArchingItems3.map((item, key) => (
                <RadioButton
                  key={key}
                  button={item}
                  onClick={this.changeActiveRadioArchingButton3.bind(this, key)}
                />
              ))}
            </View>
            ...
            <View style={styles.flexDirection}>
              {this.state.radioArchingItems4.map((item, key) => (
                <RadioButton
                  key={key}
                  button={item}
                  onClick={this.changeActiveRadioArchingButton4.bind(this, key)}
                />
              ))}
            </View>
